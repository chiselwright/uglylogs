# vim:ts=4:sw=4:ai:
# $Id: BOOT.pm,v 1.1 2002/03/15 11:39:11 chiselwright Exp $

package UglyMUG::Log::Handler::BOOT;
...
This is the B<BOOT> specific entry handler.
It formats entries to look like

  [TimeStamp] PlayerName(#PlayerID) was booted by PlayerName(PlayerID): Reason

This is then appended to the B<boot> log in the B<day> directory under B<admin>.
...
sub process ($) {
	...
	# GRIPE format: targetid|targetname|booterid|bootername|reason
	my (
		$timestamp,
		$targetid,
		$targetname,
